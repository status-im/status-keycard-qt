    ...
    , m_commandExecutionCount(0)
{
    ...
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] Created";
}

MockCommunicationManager::~MockCommunicationManager()
{
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] Destroyed";
}
...
{
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] Simulating card detected:" << uid;
    ...
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] Emitting cardInitialized signal";
    emit cardInitialized(result);
}

void MockCommunicationManager::simulateCardRemoved()
{
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] Simulating card removed";

    m_currentCardUID.clear();

    // For unit tests, emit synchronously for deterministic behavior
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] Emitting cardLost signal";
    emit cardLost();
}
...
{
    m_mockAppInfo = info;
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] Application info updated";
}

void MockCommunicationManager::setMockApplicationStatus(const Keycard::ApplicationStatus& status)
{
    m_mockAppStatus = status;
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] Application status updated";
}

void MockCommunicationManager::setNextCommandResult(const Keycard::CommandResult& result)
{
    m_commandResults.push(result);
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] Queued command result, queue size:" << m_commandResults.size();
}
...
void MockCommunicationManager::setDefaultCommandResult(const Keycard::CommandResult& result)
{
    ...
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] Default command result set";
}
...
void MockCommunicationManager::clearCommandResults()
{
    ...
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] Command results cleared";
}
...
void MockCommunicationManager::resetStatistics()
{
    ...
    m_commandExecutionCount = 0;
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] Statistics reset";
}
...
{
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] stopDetection() called";
    m_detectionStarted = false;
}
    ...
    std::unique_ptr<Keycard::CardCommand> cmd)
{
    ...
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] executeCommandSync:" << m_lastCommandName
    ...
    if (!m_commandResults.empty()) {
        ...
        m_commandResults.pop();
        qDebug() << "StatusKeycardQt::[MockCommunicationManager] Returning queued result, remaining:"
                 << m_commandResults.size();
    } else if (m_hasDefaultResult) {
        result = m_defaultCommandResult;
        qDebug() << "StatusKeycardQt::[MockCommunicationManager] Returning default result";
    } else {
...
void MockCommunicationManager::startBatchOperations()
{
    ...
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] startBatchOperations, count:" << m_batchOperationCount;
}
...
void MockCommunicationManager::endBatchOperations()
{
    ...
    qDebug() << "StatusKeycardQt::[MockCommunicationManager] endBatchOperations, count:" << m_batchOperationCount;
}
