...
private slots:
    ...
    void testECDSARecoveryWithValidSignature()
    {
        ...
        qDebug() << "StatusKeycardQt::Generated public key:" << publicKey.toHex();
        ...
        qDebug() << "StatusKeycardQt::Signature R:" << r.toHex();
        qDebug() << "StatusKeycardQt::Signature S:" << s.toHex();
    ...
    void testRealWorldTLVResponse()
    {
        ...
        qDebug() << "StatusKeycardQt::TLV response size:" << tlvResponse.size();
        ...
        qDebug() << "StatusKeycardQt::Extracted public key:" << publicKey.toHex();
        ...
        qDebug() << "StatusKeycardQt::Extracted R:" << r.toHex();
        qDebug() << "StatusKeycardQt::Extracted S:" << s.toHex();
