...
{
    qDebug() << "StatusKeycardQt::StoreMetadataFlow: Starting execution" << params();
    ...
    if (cardName.length() > maxCardNameLength) {
        qDebug() << "StatusKeycardQt::StoreMetadataFlow: Truncating card name from" << cardName.length()
                 << "to" << maxCardNameLength << "characters";
        cardName = cardName.left(maxCardNameLength);
    }

    qDebug() << "StatusKeycardQt::StoreMetadataFlow: Storing card name:" << cardName;
    ...
    qDebug() << "StatusKeycardQt::StoreMetadataFlow: Metadata stored successfully";
